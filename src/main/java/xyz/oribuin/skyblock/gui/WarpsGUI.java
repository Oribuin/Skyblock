...
class WarpsGUI(rosePlugin: RosePlugin) : xyz.oribuin.skyblock.gui.PluginGUI(rosePlugin) {
    ...
    fun openMenu(member: Member) {
        ...
        this.put(gui, "back-item", player) { this.menuManager[xyz.oribuin.skyblock.gui.PanelGUI::class].openMenu(member) }
