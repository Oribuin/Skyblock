...
class PanelGUI(rosePlugin: RosePlugin) : xyz.oribuin.skyblock.gui.PluginGUI(rosePlugin) {
    ...
    fun openMenu(member: Member) {
        ...
        this.put(gui, "members-item", player) { menuManager[xyz.oribuin.skyblock.gui.MembersGUI::class].openMenu(member) }
        this.put(gui, "settings-item", player) { menuManager[xyz.oribuin.skyblock.gui.SettingsGUI::class].openMenu(member) }
        this.put(gui, "warps-item", player) { menuManager[xyz.oribuin.skyblock.gui.WarpsGUI::class].openMenu(member) }
